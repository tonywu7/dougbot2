...
from ...exts.acl.models import AccessControl, Action, RoleModifier
...
class AccessControlType(ObjectType):
    ...
    modifier: int = Field(Enum.from_enum(RoleModifier), required=True)
    action: str = Field(Enum.from_enum(Action), required=True)
