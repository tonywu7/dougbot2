...
from ...utils.english import QuantifiedNP as NP
...
def setup(bot: MissionControl) -> None:
    ...
    doc.register_type(bool, NP('yes or no', concise='yes/no', definite=True, uncountable=True))

    doc.register_type(discord.User, NP('ID', 'name', 'mention', concise='user', attributive="Discord user's"))
    doc.register_type(discord.Member, NP('ID', 'name', 'mention', concise='user', attributive="Discord user's"))
    doc.register_type(discord.Message, NP('ID', 'URL', concise='message', attributive="message's"))
    doc.register_type(discord.PartialMessage, NP('ID', 'URL', concise='message', attributive="message's"))
    doc.register_type(discord.Role, NP('ID', 'name', 'mention', concise='role', attributive="role's"))
    doc.register_type(discord.TextChannel, NP('ID', 'name', concise='text channel', attributive="text channel's"))
    doc.register_type(discord.VoiceChannel, NP('ID', 'name', concise='voice channel', attributive="voice channel's"))
    doc.register_type(discord.StageChannel, NP('ID', 'name', concise='stage channel', attributive="stage channel's"))
    doc.register_type(discord.CategoryChannel, NP('ID', 'name', concise='channel category', attributive="channel category's"))
    doc.register_type(discord.Colour, NP('color', predicative='in hexadecimal or RGB format'))
    doc.register_type(discord.Emoji, NP('emote', predicative='must be in servers the bot is in'))
    doc.register_type(discord.PartialEmoji, NP('emote ID'))
    doc.register_type(discord.Guild, NP('ID', 'name', concise='server', attributive="server's"))

    doc.register_type(_AnyChannel, NP('ID', 'name', concise='channel', attributive="channel's"))
    doc.register_type(_TextAndVCs, NP('ID', 'name', concise='channel', attributive="channel's"))
    doc.register_type(_VCs, NP('ID', 'name', concise='channel', attributive="voice channel's"))
