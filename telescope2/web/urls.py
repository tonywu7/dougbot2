...
urlpatterns = [
    ...
    re_path(r'^guild/(?P<guild_id>[0-9]+)/join$', views.join, name='web.join'),
    re_path(r'^guild/(?P<guild_id>[0-9]+)/leave$', views.leave, name='web.leave'),
    re_path(r'^joined$', views.CreateServerProfileView.as_view(), name='web.authorized'),
]
