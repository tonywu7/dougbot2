...
const PERMISSIONS: Record<string, { content: string; foreground: string }> = {
    ...
    add_reactions: { content: 'Add Reactions', foreground: '#cf1f33' },
    stream: { content: 'Stream', foreground: '#cf1f33' },
    read_messages: { content: 'View Channels', foreground: '#cf1f33' },
    send_messages: { content: 'Send Messages', foreground: '#cf1f33' },
    send_tts_messages: { content: 'Send TTS Messages', foreground: '#cf1f33' },
    embed_links: { content: 'Embed Links', foreground: '#cf1f33' },
    attach_files: { content: 'Attach Files', foreground: '#cf1f33' },
    read_message_history: {
        content: 'Read Message History',
        foreground: '#cf1f33',
    },
    external_emojis: { content: 'Use External Emotes', foreground: '#cf1f33' },
    connect: { content: 'Connect', foreground: '#cf1f33' },
    speak: { content: 'Speak', foreground: '#cf1f33' },
    use_voice_activation: {
        content: 'Use Voice Activation',
        foreground: '#cf1f33',
    },
    change_nickname: { content: 'Change Nickname', foreground: '#cf1f33' },
    use_slash_commands: {
        content: 'Use Slash Commands',
        foreground: '#cf1f33',
    },
    request_to_speak: { content: 'Request To Speak', foreground: '#cf1f33' },
}
