...
class ACLRoleModifier(models.IntegerChoices):
    NONE = 0, 'none of'
    ANY = 1, 'any of'
    ALL = 2, 'all of'
...
class AccessControl(models.Model):
    ...
    modifier: int = models.IntegerField(choices=ACLRoleModifier.choices)
    action: str = models.CharField(max_length=120, choices=ACLAction.choices)
    ...
    def enabled(self) -> bool:
        return self.action == ACLAction.ENABLED.value
